...
2. **Remote in-flight branches.** List every `Codex/*` branch on origin —
...
6. **Decide, do not ask.** Per AGENTS.md IX.D autonomy: if an open PR + live
