...
| 마지막 main 커밋 | `9bfa55d Merge pull request #165 — feat(035) forward 엣지 자동 판정 폐회로` |
...
| main 테스트 | 1453 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
