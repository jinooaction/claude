...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `da57dde` — Merge pull request #832 from jinooaction/codex/189-kis-cursor-boundary |
...
| 활성 작업 | 189 경계 대안 실제 확인 완료. 공식 약1개월 설명과 실제20일 반환 일치.736일 부족 유지, KIS만으로 소급 확보 가능한 경로는 미확인. 신규 가입 대기 없음. |
