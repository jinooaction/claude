...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `0beb7d7` — Merge pull request #835 from jinooaction/codex/189-source-provenance-followup |
...
| 열린 PR | #827 유료 공급자 초안 보류. #836 연구 자산 고갈/마감 진입 보정, 전체 회귀 4,776/13 통과 후 병합 단계. 원격 상태 확인 필요. |
...
| 활성 작업 | HF Data Library 실제5종목/1,645연속 세션 18후보 재생 완료. 선택 후보80거래/비용 후 손실로 미통과. #836 검증 완료와 후속 전략 연구.189/hf-revalidation.md 참고. |
