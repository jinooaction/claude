...
## 최근 마일스톤 — 2026-05-23 (라이브 worker dry-run 시작)
...
* **main의 테스트**: 743 통과, 4 스킵 (라이브 KIS 스모크 4건은 `KIS_LIVE_TEST=1` 환경변수로 게이트).
...
| 마지막 main 커밋 | `e949451 Merge PR #53 — docs(constitution): 원칙 X 신설 (v3.1.0)` |
| 활성 작업 | 라이브 worker dry-run 가동 중 (2026-05-23 시작). 1주일 안전 관찰 단계 — `HANDOFF-014-LIVE-DRYRUN-STARTED.md`. 실거래 전환은 운영자 명시 지시 필요 |
| 출시 완료 스펙 | 001, 002, 003, 006, 007, 008, 009, 010 |
| 진행 중 스펙 | 011 (성과 측정) — P1(라이브 성과 측정)·P2(위험조정 성과 지표) main 머지, P3~P5 대기 |
...
| main 테스트 | 774 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
