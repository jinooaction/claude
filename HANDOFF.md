...
관련37개/ruff 통과. PR837 초안이며 독립 증거 검사·confirm 구현·전체 회귀는 남았다.
...
| 열린 PR | #827 유료 공급자 초안 보류. #836 병합 완료. #837 비용 고려 단타 연구 초안, 개발6후보 탈락·후속 구현 중. |
...
| 활성 작업 | HF Data Library 실제1645세션 기존18후보 미통과.190 신규6후보도 개발 비용 후 탈락. 독립 증거/확인 경계 구현 중, 최종확인495일 성과 미개봉. |
