...
## 최근 마일스톤 — 2026-05-30 (스펙 029 슬라이스 1: 라이브 포트폴리오 순자산(NAV) 추적 — 측정 전용)
...
| main 테스트 | 1273 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
