...
개인 Stocks Starter 첫1개월29달러 비용 질문의 답변도 아직 없다. 결제·실제 다운로드·
...
| 열린 PR | #827 초안:187 장기 자료 수집·연구 연결. 코드 검사 완료, 실제 자료 단계는 비용 승인·키 연결 대기. #793은 머지 완료. |
...
| 활성 작업 | 187 장기 실제 자료 수집기와 독립 연구 연결 검증 중. 실제756일 확보는 Massive 비용 승인과 안전한 키 연결 대기. 184 구현·배포 완료와 실제 가동 적격은 구분한다. |
