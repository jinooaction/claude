...
| 마지막 main 커밋 | `f5cf670 Merge pull request #182 — feat(041) 절대 기대수익 게이트(듀얼 모멘텀) + 유니버스 28→89 + 라이브 중단` |
...
| main 테스트 | 1490 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
