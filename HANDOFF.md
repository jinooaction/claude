...
| 마지막 main 커밋 | `96ff217 Merge pull request #179 — feat(040) (A) 룰 워커 끄고 포트폴리오 전략 교체·무장` |
...
| main 테스트 | 1488 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
