...
| 활성 작업 | #749을 exact main으로 배포하고 KIS smoke 6/6·`ENTRY_READY` 주문 없는 사전점검까지 확인했다. 다음 XNYS 정규장의 자동 GitHub schedule 또는 server timer에서 신규 주문 접수·실제 체결·전략 감사·계좌 대사·다른 scheduler 중복 0건을 확인해야 스펙 176이 완료된다. |
