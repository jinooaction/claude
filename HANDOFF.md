...
아래 단계별 과거 기록보다 이 전체 결과를 우선한다. 생산 계좌의 장중 현금/전체 자산
계산 근거가 없어 T009/T010은 미완료다. 임의 현금·자산 값이나 시험용 자격을 생산 입력으로
바꾸지 않는다. 문의 본문은 승인됐지만 접수창의 개인정보 동의/입력은 완료되지 않았으며
접수·답변 증거도 없다. 2026-09-10 공식 비회원 접수창에서 동일 조건을 재확인했다.
