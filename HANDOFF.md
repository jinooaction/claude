...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `aeace15` — Merge pull request #811 from jinooaction/codex/account-source-collection |
| main 테스트 | 코드85db517/main aeace15 전체3890 passed/12 skipped(763.73초). 제외는 실제 KIS11개와 가동 전 상태 전용1개. 실제34690683642는11 passed/24.44초, 원본10응답·장부순번8·국내 현재잔고 수집 성공. |
| main 린트 | 코드85db517/main aeace15의 `uv run ruff check src tests` 통과. |
| 열린 PR | #793은 스펙184 초안이다. 195c23d 전체3906/11(796.72초) 통과 후 main8e2e5ce를0471431로 통합했다. 독립/운영자 명령 두 경로와 인계 관련38개(6.91초)·린트·하네스14/14 통과. |
