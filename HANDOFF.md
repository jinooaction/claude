...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `83c6d20` — Merge pull request #845 from jinooaction/codex/193-observed-intraday-inputs |
...
| 활성 작업 |193 완료 후 당시30종목 원본 수집·가격 연결 조사. 기존29전략 미통과와 추가 거래량 결합 가설 실패를 보존해 향후 최소30가설을 계상한다. 최종확인495일 성과 미개봉. 통과전략·전진관찰·실행 동등성·실제 운영 검증이 남음. |
