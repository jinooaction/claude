...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `3c86569` — Merge pull request #830 from jinooaction/codex/189-kis-five-symbol-review |
| main 테스트 | 실행b55f480 전체4767 passed/13 skipped(816.51초). main3c86569 실제34854081485 KIS12개 통과(109.94초),5종목20완결일과36회 단기 재생 완료. |
| main 린트 | 실행b55f480의 `uv run ruff check src tests` 및 하네스14/14 검사 통과. |
...
| 활성 작업 | 189 한국투자5종목20완결일 수집과36회 단기 재생 완료. 신규 가입 대기 없음. 장기 적격은736일 자료 부족이며 기존 한국투자 수집을 유지한다. |
