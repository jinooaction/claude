...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `675fe93` — Merge pull request #817 from jinooaction/codex/account-source-collection |
| main 테스트 | 코드fe08a91/main675fe93 전체4011 passed/12 skipped(749.77초). 제외는 실제 KIS11개와 사전 가동 상태 전용1개. 실제34697142253 검사 진행 중. |
| main 린트 | 코드fe08a91/main675fe93의 `uv run ruff check src tests` 및 진단 스크립트 검사 통과. |
| 열린 PR | #793은 스펙184 초안이다. 실행 코드a8beac7 전체4592 passed/12 skipped(810.45초). 현재9b8ce2a는 main965ecee 통합으로 관련153개(1.49초)·린트·하네스14/14·인계 통과. 전체 계좌 계산과 T009/T010은 미완료. |
