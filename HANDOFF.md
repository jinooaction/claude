...
## 최근 마일스톤 — 2026-05-30 (스펙 028: 체결 품질 정밀 측정 — arrival 기준 구현격차 + 체결 지연)
...
| main 테스트 | 1260 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
