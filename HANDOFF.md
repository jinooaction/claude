...
| 마지막 main 커밋 | `bd442ba Merge pull request #135 — feat(032) rebalance-once 안전 강화(드라이런+라이브 인터록)` |
...
| main 테스트 | 1386 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
