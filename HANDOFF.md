...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `2d79712` — Merge pull request #798 from jinooaction/codex/182-account-assets |
...
| 활성 작업 | US9/US10의 실제 조회·대조는 완료했다. 전체 자산19분류와 각5열 합은 일치했지만 별도 순자산 요약과 차이가 있고, 해외 원화 합계3개도 불일치다. 수치 차이의 집계 기준·장중 USD 현금/NAV·#793 실주문 시작 연결은 미완료다. 기존 한국투자 계좌를 유지한다. |
...
## 현재 진행 — 2026-09-09 KST (스펙182 실제 산술 대조)
