...
| 활성 작업 | 앱과 공개 상태판은 출시됐고 시뮬레이터 네 탭에서 실제 공개 자료를 확인했다. 실제 iPhone은 `unavailable`이라 서명 설치·실행·네 탭·잠금 보호막 실기기 검증만 남았다. 실행 관측 FR-023~025와 T031 배포 확인 완료. 계좌 총액/NAV 집계와 단타 실거래 T010~T012는 계속 미완료다. KIS 문의는 개인정보 동의·본인확인 단계의 사용자 처리를 기다리며 아직 미발송이다. |
...
## 현재 진행 — 2026-09-08 KST (스펙183 모바일 자금·전략 운영판 출시)
