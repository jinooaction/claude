...
| 마지막 main 커밋 | `127ca3f Merge pull request #103 from jinooaction/claude/serene-knuth-xDbnN` |
| 활성 작업 | **없음 — 스펙 025(다요인 합성 알파 점수 필터) 완료·머지(2026-05-30, PR #103 `127ca3f`).** 라이브 worker dry-run 가동 중. 다음 후보: 실거래 캐너리 전환(운영자 명시 지시 필요), 베타 인식 노출 조절, 회전율 인식 리밸런싱 |
