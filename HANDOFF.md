...
| 활성 작업 | 실행 관측 FR-023~025와 T031 배포 확인 완료. 계좌 현금/NAV·전체 범위·시세 공급 계약·과거/전진·생산 연결/체결은 미완료. KIS 문의6개 질문 발송은 운영자 승인 완료. 구 Q&A 종료를 공식 확인했고 현재 고객의 소리 개인정보 동의·본인확인 단계의 사용자 처리를 기다림. 아직 미발송, 실제 자금 배정·주문0. |
...
## 현재 진행 — 2026-09-08 KST (스펙182 다중 USD 조회 보정)
