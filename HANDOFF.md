...
| 열린 PR | 없음. |
| 출시 완료 스펙 | 최신 기능: #657(스펙 151, 시점 기준 독립 거시 전략 64개·사전 탐색 192개·생산 256개를 합친 512회 검정과 주문 전 자료 관문), #653(스펙 150, 자동 전략 공장), #646~#651(스펙 149, 첫 주문 직전 최신 엣지 재검증·자동 강등), #644(스펙 148, 정합성 halt 조건부 자동 복구). |
| 골격 스펙 | 없음. 스펙 151 T001~T028은 모두 완료됐다. 다음 독립 전략군은 아직 새 SDD로 사전등록하지 않았다. |
| 최근 출시 작업 | 스펙 151의 수익률곡선·물가 방향·실시간 고용 충격·VIX 충격 회복 64개를 생산에서 검증했다. 512개 고유 지문을 모두 계산했지만 PBO와 PSR 관문 실패로 `NO_FACTORY_EDGE`다. |
| 활성 작업 | 코드 PR 없음. 다음 작업은 `independent_asset_universe_or_carry`, 즉 자산군 확대 또는 캐리처럼 경제 근거가 다른 전략군의 사전등록이다. 현재 `armed:false`, 단 0/5, 자본 0, 주문·체결 0건, 전략 손익 0달러다. |
