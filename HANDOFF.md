...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `8ec597b` — Merge pull request #803 from jinooaction/codex/account-source-collection |
| main 테스트 | 코드513b33a/main8ec597b의 전체3821 passed/12 skipped, 실패0(814.99초). 제외는 실제 읽기11개와 가동 전 조건1개다. 실제34630508745는11 passed/23.65초, 원본9응답·관측순번1 저장 성공. |
| main 린트 | 코드513b33a/main8ec597b의 `uv run ruff check src tests` 통과. |
