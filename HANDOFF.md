...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `6580c05` — Merge pull request #836 from jinooaction/codex/189-intraday-bankrupt-metrics |
| main 테스트 | 실행5535fdf 전체4776 passed/13 skipped(1150.92초). main6580c05 실제35541770144 KIS12개 통과(111.83초). |
| main 린트 | 실행5535fdf의 `uv run ruff check src tests`와 후속 문서 검증, 하네스14/14 검사 통과. |
| 열린 PR | #827 유료 공급자 초안 보류. #836 병합 완료. #837 비용 고려 단타 연구, 개발6후보 탈락·독립검사·전체4797/13 통과 후 병합 단계. |
...
| 활성 작업 | HF Data Library 실제1645세션 기존18후보 미통과.190 신규6후보도 개발 비용 후 탈락. 독립 재생/확인 경계·전체 회귀 검증 완료. 최종확인495일 성과 미개봉. |
