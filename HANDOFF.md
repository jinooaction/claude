...
| 활성 작업 | #773 자금 검토 CLI와 100/600달러 보고서가 병합됐다. 600달러는 참고 시세상 TLT1주만 가능하며 아직 운영자가 결정한 금액이 아니다. 검증된 NAV·실제 역사/전진 증거·생산 단타 권한/계좌 연결·체결 증거가 남았다. 자금 변경·주문0, 기존 저빈도 자본·권한 불변. |
