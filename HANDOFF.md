...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `c3c41ff8` — Merge pull request #756 from jinooaction/codex/176-dual-scheduler-production-proof |
...
| 열린 PR | 스펙 180 첫 체결 전 검증·실행 자본 정합 작업 중. 실제 열린 PR은 GitHub에서 확인한다. |
...
현재 main c3c41ff8은 21:00 UTC 배포됐다. audit33925197841의 correlation
