...
## 최근 마일스톤 — 2026-05-26 (스펙 012: 튜너 L2/L3 → 하드닝 캐너리 자동 투입)
...
| 마지막 main 커밋 | `943c08b Merge PR #67 — feat(012): 튜너 L2/L3 → 하드닝 캐너리 자동 투입·검증` |
| 활성 작업 | **없음 — 스펙 012(튜너 L2/L3 → 하드닝 캐너리 자동 투입) 완료·머지(2026-05-26, PR #67 `943c08b`).** 라이브 worker dry-run 가동 중. 다음 후보: L1 적용 표면 확장(이제 캐너리 검증 경로가 있으니 안전 승격 검토 가능), L2/L3 합격→운영자 승격 큐, 모델 교체 노브. 실거래 전환은 운영자 명시 지시 필요 |
| 출시 완료 스펙 | 001, 002, 003, 004, 005, 006, 007, 008, 009, 010, 011, 012 |
| 진행 중 스펙 | 없음 |
| 골격 스펙 (즉시 착수 가능) | 없음 — 빌드 가능한 스펙 전부 출시. 후속은 L1 적용 표면 확장 등(스펙 012 이후 후보, HANDOFF-018 참조) |
...
| main 테스트 | 942 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
