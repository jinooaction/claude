...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `2f7c11f` — Merge pull request #807 from jinooaction/codex/account-source-collection |
| main 테스트 | 코드772915d/main2f7c11f 전체3853 passed/12 skipped(761.84초). 제외는 실제 KIS11개와 가동 전 상태 전용1개. 실제34685116089은11 passed/26.44초, 원본9응답·장부순번6·현금 대조 성공. |
| main 린트 | 코드772915d/main2f7c11f의 `uv run ruff check src tests` 통과. |
