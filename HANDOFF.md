...
| 활성 작업 | 확정600/12·모의 검증·페이지/OTCB/USD 미제공 보정은 병합·배포됐다. 공식 공란 통화 행의 별도 집계 보정에서 관련103개 통과, 전체 회귀/병합/실제 읽기 검증 중이다. 자금 배정·주문0, NAV·전략/전진 증거·생산 주문 연결은 미완료다. |
