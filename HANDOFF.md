...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `a5d61ff` — Merge pull request #797 from jinooaction/codex/182-account-assets |
...
| 열린 PR | #793은 스펙184 시세 입력·기존 보유 분리·주문 관리의 초안이다. #794~#797의 산술/진단/전체 자산 조회와 실제 인계를 이 개발 브랜치에도 반영했다. 실주문 시작 연결은 미완료다. |
