...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `854d81f9` — Merge pull request #757 from jinooaction/codex/180-prefill-capital-parity |
...
| 열린 PR | 스펙 180 기능 PR #757 머지 완료. 생산 인계 갱신 진행 중이며 실제 열린 PR은 GitHub에서 확인한다. |
