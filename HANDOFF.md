...
## 최근 마일스톤 — 2026-05-27 (스펙 014: 라이브 손실 서킷 브레이커)
...
- `HANDOFF-019-SPEC-014-CIRCUIT-BREAKER.md` — **최신**. 스펙 014 라이브 손실 서킷 브레이커 출시 (2026-05-27, PR #71 `2c1b8aa`). 손실 한도(일일 실현/전체 낙폭) 초과 시 워커 자동 정지. 순수 방어적, 한도는 K1 보호. 다음 세션 참고.
...
| 마지막 main 커밋 | `2c1b8aa Merge PR #71 — feat(014): 라이브 손실 서킷 브레이커` |
| 활성 작업 | **없음 — 스펙 014(라이브 손실 서킷 브레이커) 완료·머지(2026-05-27, PR #71 `2c1b8aa`).** 라이브 worker dry-run 가동 중. 다음 후보: 모델 교체 노브, L1 적용 표면 확장, L2/L3 합격→운영자 승격 큐, 체결 품질·부분체결 처리(분석 2순위). 실거래 전환은 운영자 명시 지시 필요 |
| 출시 완료 스펙 | 001, 002, 003, 004, 005, 006, 007, 008, 009, 010, 011, 012, 013, 014 |
| 진행 중 스펙 | 없음 |
...
| main 테스트 | 995 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
