...
전체 pytest는 `/tmp/auto-invest-196-pytest.log`에 기록 중이다. 실행 핸들75776의 종료 상태를
먼저 확인하며 살아 있는 검사를 다시 시작하지 않는다. 현재 전체 통과·병합·배포 완료는 아니다.
현재 명세는 specs/196-archived-event-evidence/tasks.md이며 T010~T011이 남았다.
...
| 열린 PR | #853 과거 보관 원문·수집 근거 검사, 전체 회귀 진행 중인 초안. #827 유료 공급자 초안 보류. |
...
| 활성 작업 |196 보관 근거 검사 관련62개·실제WMT 정상/변조 검사 통과. 전체 회귀 종료와 출시 확인 진행. 최소31가설 실패를 보존하며 새 성과 가설은 미선정. 최종확인495일 미개봉. 전체 자료 범위·통과 전략·전진 관찰·실행 동등성·실제 운영 검증이 남음. |
