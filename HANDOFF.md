...
186 FR008 구현: 동일 저장 원본에서 전체 자산표5열·OTCB 수량/가격/평가액·요약
현금/채무 항목을 누락/0/양수/음수로 구분한다. 종목·금액·임의 원문은 공개하지 않는다.
관련65개(0.33초)·린트·하네스14/14·인계 통과. 실제 미해석 자산이0수량 표시 행인지
양수 보유인지 아직 확인 전이며 전체 회귀·서버 적용은 후속이다. 실행 판정은 유지한다.
