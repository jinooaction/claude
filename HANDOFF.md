...
| 활성 작업 | 실행 관측 FR-023~025: 매도가능수량·시세 발생시각 필수 전달, 오래된 가격의 신규 매수/매도 차단과 기존 취소 보존. 관련81개 통과/전체 회귀 진행. 조회 T020/T028 완료이며 집계/NAV·과거/전진·생산 연결/체결은 미완료. 자금 배정·주문0. |
...
신선도·대사·권한을 유지한다. 관련81개와 모의600/12 검사는 통과, 전체 회귀 진행 중.
