...
| 마지막 main 커밋 | `50f0c44 Merge PR #14: GitHub Actions로 Vultr 자동 생성 (옵션 D)` |
| 활성 작업 | 운영자가 옵션 B로 Vultr 콘솔에서 인스턴스 가동 (2026-05-16, IP 202.182.125.132). KIS 키 입력 + 1주일 dry-run 관찰 단계. |
