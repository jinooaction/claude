...
현재190 비용 고려 단타 연구를 별도 브랜치에서 사전등록 중이며 새 후보 성과는 아직
계산하지 않았다. 기존1645일 결과는 미통과로 보존한다. 새6후보·개발/확인 분리·기존18후보
다중비교 기록은 specs/190-cost-aware-intraday/plan.md와 tasks.md에서 이어받는다.
...
| 열린 PR | #827 유료 공급자 초안 보류. #836 병합 완료.190 비용 고려 단타 후보 연구 준비 중. |
...
| 활성 작업 | HF Data Library 실제1645세션 기존18후보 미통과.190 신규6후보 사전등록과 개발/확인 분리 구현. 최종확인495일 성과 미개봉. |
