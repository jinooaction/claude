...
## 최근 마일스톤 — 2026-05-31 (스펙 032 슬라이스 1: 횡단면 포트폴리오 재조정 엔진)
...
| main 테스트 | 1381 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
