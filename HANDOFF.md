...
## 최근 마일스톤 — 2026-05-30 (스펙 029 슬라이스 2: 자산 인식 유효 자본 — 캡 기준이 라이브 순자산 추종)
...
| main 테스트 | 1288 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
