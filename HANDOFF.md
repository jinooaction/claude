...
- **⚠ 운영자 결정 대기(라이브 무장 전 필수)**: 라이브 `data/halt.flag` 가 2026-06-04 묵은
...
| main 테스트 | 1697 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
