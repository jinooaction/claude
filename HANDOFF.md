...
| 활성 작업 | 오너가 2026-09-05 KST 해외 ETP 신청 완료를 확인했다. 신청 후 no-order run33925261456은 현재 가격에서 과거 예산142의 정수주 비중오차로 ENTRY_BLOCKED였다. 스펙180은 현재 NAV10% 검증예산143과 승인예산의 정합을 보정하며 임계값·자본 비율을 높이지 않는다. 실제 신규 접수·체결은 아직0건이다. |
