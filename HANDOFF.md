...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `9df3a25` — Merge pull request #848 from jinooaction/codex/194-sparse-opening-research |
...
| 활성 작업 |194 실제30종목1515일 후보는 기준/가혹 비용 모두 탈락. 최소31가설을 계상하며 후속 가설은 아직 미선정. followup-decision.md 참조. 최종확인495일 성과 미개봉. 통과 전략·전진 관찰·실행 동등성·실제 운영 검증이 남음. |
