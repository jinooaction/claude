...
## 한눈 요약표 — 2026-09-08 KST 실제 계좌 조회 완료·실행 관측 보정 중

| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `8e02147` — Merge pull request #784 from jinooaction/codex/182-account-read-completion |
| main 테스트 | #783 코드41d5770 전체3629 passed/9 skipped, 실패0(805.92초). 관련113개 통과. 실제 KIS34170209460은8/8 통과(21.32초), USD10행 조회 완료. 집계/NAV 합격을 뜻하지 않는다. |
| main 린트 | #783 코드41d5770에서 `uv run ruff check src tests` 통과. |
| 열린 PR | #784까지 병합 완료. `codex/182-execution-observation-contract`에서 매도가능수량·시세 발생시각·취소 분리를 보정 중. 열린 PR은 GitHub에서 다시 확인한다. |
...
| 활성 작업 | 실행 관측 FR-023~025 PR785: 관련81개·전체3660 passed/9 skipped(767.15초), 린트·하네스14/14 통과. 매도가능수량/시세 시각 검증과 기존 취소 보존. 병합·배포 확인 대기. 조회 T020/T028 완료, 집계/NAV·과거/전진·생산 연결/체결 미완료. |
...
(767.15초), 린트·모의600/12·하네스14/14·인계 검사 통과. PR785 병합·배포 확인 대기.
