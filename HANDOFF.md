...
## 한눈 요약표 — 2026-09-07 KST 준비 기준 반영·실계좌 USD 해석 확인 대기

| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `d602525` — Merge pull request #781 from jinooaction/codex/182-blank-margin-rows |
...
| 열린 PR | #775~#781 병합 완료. `codex/182-preparation-completion-proof`는 검증과 외부 확인 사항만 인계한다. 열린 PR은 GitHub에서 다시 확인한다. |
...
| 활성 작업 | 확정600/12·모의 검증·KIS 읽기/진단 코드는 병합·배포됐다. 실제 USD10행의 행 의미·합산/대표 선택 규칙이 공식 자료에 없어 KIS 답변 대기(T020/T027)다. 문의 초안 작성, 미발송. 자금 배정·주문0, NAV·전략/전진 증거·생산 주문 연결(T010~T012)은 미완료다. |
