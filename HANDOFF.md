...
| 열린 PR | #793은 스펙184 시세 입력·기존 보유 분리·주문 관리의 초안이다. 별도 codex/182-balance-audit에서 현재잔고의 실제 산술 대조를 검증 중이다. |
...
| 활성 작업 | 스펙182 US9 잔고의 수량·가격·평가·손익·원화 합계 산술 대조를 구현했다. 새23개 포함 관련141개·전체3733 passed/10 skipped(804.19초)·린트·하네스14/14 통과. 기존 계좌 실제 확인은 main 반영 후 기존 읽기 경로에서 진행한다. 전체 NAV 합산식과 장중 발생시각은 별도 미검증이며 #793의 실주문 시작 연결도 미완료다. 기존 한국투자 계좌 사용은 확정됐다. |
