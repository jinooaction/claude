...
| main 테스트 | 코드c13f773/main965ecee 전체3913 passed/12 skipped(765.67초). 제외는 실제 KIS11개와 사전 가동 상태 전용1개. 실제34696061360은11 passed(25.60초), 원본10응답·순번10 COMPLETE·주문0. |
| main 린트 | 코드c13f773/main965ecee의 `uv run ruff check src tests` 및 진단 스크립트 검사 통과. |
