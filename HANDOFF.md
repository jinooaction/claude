...
## 최근 마일스톤 — 2026-05-26 (스펙 005 후속: 자율 튜너 오프아워 타이머 연결)
...
- `HANDOFF-017-TUNER-SCHEDULING.md` — **최신**. 스펙 005 후속: 자율 튜너 오프아워 타이머 연결 (2026-05-26, PR #63 `92dd0ff`). 튜너가 매일 장 마감 후 자동 실행. 다음 세션 참고.
...
| 마지막 main 커밋 | `92dd0ff Merge PR #63 — feat(005-후속): 자율 튜너 오프아워 타이머 연결` |
| 활성 작업 | **없음 — 스펙 005 후속(자율 튜너 오프아워 타이머 연결) 완료·머지(2026-05-26, PR #63).** 라이브 worker dry-run 가동 중 (2026-05-23 시작). 다음 후보: L1 적용 표면 확장(모델 라우팅·캐시 TTL 노브 — **K3 인접, 자동화 신중**), L2/L3→캐너리 자동 큐. 실거래 전환은 운영자 명시 지시 필요 |
| 출시 완료 스펙 | 001, 002, 003, 004, 005, 006, 007, 008, 009, 010, 011 |
| 진행 중 스펙 | 없음 |
| 골격 스펙 (즉시 착수 가능) | 없음 — 빌드 가능한 스펙 전부 출시. 후속은 L1 적용 표면 확장 등(스펙 005 후속 후보, HANDOFF-016·017 참조) |
...
| main 테스트 | 895 통과, 4 스킵 (라이브 KIS smoke 4건, `KIS_LIVE_TEST=1` 가드) |
