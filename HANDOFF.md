...
2026-09-21 최신(이 PR에서 검증 중): HF Data Library 무료 계정 연결·프로필 등록 후
...
최신 전체 회귀는 실행 중. PR836 초안이며 병합/배포 완료로 간주하지 않는다.
...
| 열린 PR | #827 유료 공급자 초안 보류. #836 연구 자산 고갈/마감 진입 보정 초안, 전체 회귀 진행 중. |
...
| 활성 작업 | HF Data Library 실제5종목/1,645연속 세션 18후보 재생 완료. 선택 후보80거래/비용 후 손실로 미통과. #836 전체 검증과 후속 전략 연구.189/hf-revalidation.md 참고. |
