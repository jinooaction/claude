...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `376f5d9` — Merge pull request #713 from jinooaction/Codex/176-preflight-report-truth |
...
| 최근 출시 작업 | 정확 배포 전략 `globalfixed-ensemble-3-6-9-12`를 알파 확정이 아닌 운영 검증으로 분류하고, 실계좌 NAV `$1427.63`의 10%를 내림한 `$142`만 단 1에 무장했다. 예상 주문은 IAUM 1주와 SCHX 2주이며 ORANY 28주는 비관리 보유로 자동 매도하지 않는다. #712는 혼잡한 정각 UTC 예약을 뉴욕 현지 10:17로 옮겼고, #713은 성공한 생산 preflight를 증거 없음으로 표시하던 운영 보고 오류를 고쳤다. |
| 활성 작업 | #713 merge `376f5d9`, 배포 `33358651283`, money-path `33358651281`이 성공했다. 생산 보고서는 마지막 사전점검 `33353865976`을 `ok=True`, `reason=ENTRY_READY`로 정확히 표시하고, 자본 `$142`, 단 1, 20% 승격 금지, 실제 전략 체결 0건을 유지한다. 다음 관찰은 2026-08-31 14:17 UTC 예약의 실제 주문·체결·감사·계좌 정합이다. |
...
## 최근 진행 — 2026-08-31 KST (#709~#713 운영 검증 캐너리 무장·예약·보고 보정, 실제 체결 대기)
