...
| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `da11ad8` — Merge pull request #851 from jinooaction/codex/195-earnings-event-inputs |
...
| 열린 PR | #827 유료 공급자 초안 보류.195 공시 입력 PR851은 병합 완료. |
...
| 활성 작업 |무료 SEC 역사 원문·접속 기록 표본 확보, 공개 시각·전달 본문 연결은 후속 검증. 최소31가설 실패를 보존하며 새 성과 가설은 미선정. 최종확인495일 미개봉. 통과 전략·전진 관찰·실행 동등성·실제 운영 검증이 남음. |
