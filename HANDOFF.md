...
## 한눈 요약표 — 2026-09-08 KST 실제 계좌 조회 완료·서버 반영 확인

| 항목 | 상태 |
|------|------|
| 마지막 main 커밋 | `a44794d` — Merge pull request #783 from jinooaction/codex/182-multirow-cash-observation |
...
| 열린 PR | #783 병합 완료. `codex/182-account-read-completion`은 실제 조회·배포 증거 인계만 변경한다. 열린 PR은 GitHub에서 다시 확인한다. |
...
| 활성 작업 | USD 단일 행 가정 제거 완료. 실제8/8·배포/감사/서비스 확인으로 T020/T028 완료. 고객센터 답변은 조회 완료의 조건이 아니다. 집계/NAV, 과거756세션·합격전략·전진60세션·생산 주문 연결/체결은 미완료. 자금 배정·주문0. |
