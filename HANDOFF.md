...
이 역사 문단 작성 당시 다음 후보였던 `115-degraded-execution-state`와 단일 `ExecutionAuthority`
통합은 각각 #517과 #519에서 닫혔다. 상세는
