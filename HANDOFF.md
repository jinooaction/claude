...
| 활성 작업 | FR-022 다중 USD 행을 그대로 보존하는 조회 보정. 고객센터 답변은 조회 완료(T020)의 선행 조건이 아니다. 집계/NAV(T027)는 별도 미확인이다. 관련113개 통과, 전체 회귀/실제 GET 재검증 진행 중. 자금 배정·주문0, T010~T012 미완료. |
...
관련113개 통과, 전체 회귀와 정상 배포/실제 GET 재검증을 진행한다.
