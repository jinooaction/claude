...
| 활성 작업 | 스펙184 실행 명령·입력기는 관련155개·전체3767/10·린트·하네스 검증 완료, PR793 초안이다. 새 입력기의 인증 후 KIS 검증, 전체 계좌 관측·단타 권한·실주문 운용 연결이 남았다. 스펙182 직접 잔고 대조와 이전 서버 검증은 완료된 과거 증거다. 실제 자료·전략 합격·정식 전진60세션·생산 체결 증거는 아직 대체하지 못했다. |
