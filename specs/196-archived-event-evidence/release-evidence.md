...
2026-09-25: 구현·관련·전체 회귀 검사 완료. 출시 확인 진행 중이며 전체 단타 목표는 미완료다.
...
T011 PR 검토·병합·배포/인계가 남는다. 전체181의 전략 통과·전진 관찰·단타 주문/청산 경로·실제 체결 대사는 이 입력 검사로 대체되지 않는다. 최종 보류 가격 자료는 열지 않았다. 제거 기능과 주문·자본·안전 관문 변경은 없다.
