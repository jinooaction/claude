...
- [x] T006 [US2] tests/unit/test_sparse_opening_research.py에 현금 예약/결제/잔량 반례를 작성한다.
- [x] T007 [US2] src/auto_invest/analytics/sparse_opening_research.py에 기간 전체 시간순 계좌와 연구 장부를 구현한다.
...
- [x] T012 HANDOFF.md에 PR병합·배포 해당 여부와 전체 목표 미완료 항목을 기록한다. PR848/main9df3a25,배포35559689034·읽기전용감사35559747577 성공. 전체 목표의181 T013~T016은 미완료다.

의존:T001→T002→T003→US1→US2→US3→출시. 같은 구현파일은 직렬로 수정한다.
T007~T009 구현/관련 검사 완료. T010에서 실제30파일 재생·별도산술 대조를 수행한다.
