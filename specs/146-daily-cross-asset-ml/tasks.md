# Tasks: Daily Cross-Asset ML Challenger

- [x] T001 Create feature specification and implementation plan.
- [x] T002 Add daily-to-weekly panel, chronology guards, models, uncertainty, allocation, costs, benchmarks, and gates.
- [x] T003 Add SQLite probe and deterministic JSON/Markdown/candidate outputs.
