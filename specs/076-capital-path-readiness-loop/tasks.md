...
- [ ] T018 Commit, push, open PR, satisfy checks, and merge when automatic merge conditions are met.
- [ ] T019 Check post-merge workflow/sidecar status and refresh HANDOFF.
