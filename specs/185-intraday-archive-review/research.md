...
실제34790306811 결과(main5fa2e20): 전체 코드 보관2묶음의 원본 검증 성공,
각5일/1일이고 모두 kis-nasdaq-partial-unadjusted, synthetic=false다.
중복 없는 실제 날짜는2026-09-04,08,09,10,11의5일이다. 두 연구 판정은 모두
INSUFFICIENT_EVIDENCE. 기존 최신 묶음의1일을 전체 보관량으로 보는 오류를
바로잡았지만5일 묶음도756일 기준에는751일 부족하다. 등록 후 전진 실적은 발급하지 않는다.
