...
- [ ] T027 KIS 공식 답변으로 USD10행 식별·필드별 합산/중복 규칙·반영 시점을 확정하고 실제 계좌 계약을 재검증. 문의 초안은 capital-review/kis-cash-contract-inquiry.md.

T020은 실제 계좌 금액 해석이 미확정이므로 미완료다. 로컬 시험/배포 완료를
실계좌 계약 합격 또는 T010~T012의 전체 실거래 완료로 바꾸지 않는다.
