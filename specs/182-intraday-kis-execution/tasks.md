...
- [ ] T025 실제34075774149의 USD_MARGIN_ROW_COUNT를 미제공/중복으로 구분, None·경고와 형식 오류 차단을 검증하고 실제 읽기 확인.
- [ ] T026 실제34076749615의 INVALID_MARGIN_CURRENCY를 공식 빈 통화 행 제외 계약과 대조해 별도 집계/미검증 경고, 누락/null 차단, 전체회귀·실제읽기 검증.
