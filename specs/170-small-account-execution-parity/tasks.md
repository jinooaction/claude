...
- [x] T015 Create and merge the grade-4 PR, verify guarded deploy, rerun no-order parity/canary/fundability sidecars, and confirm capital/orders remain zero
- [x] T016 Refresh `HANDOFF.md` with the current strategy verdict, execution readiness, and remaining first-capital blockers through the normal merge path
