...
- [x] T021 Commit, push, open PR, satisfy checks, merge when automatic merge conditions are met.
- [x] T022 Check post-merge deployment/sidecar status and refresh HANDOFF.
