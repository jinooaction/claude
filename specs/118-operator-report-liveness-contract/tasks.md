...
- [ ] T023 Create PR with risk grade, safety boundary, validation, and handoff evidence
- [ ] T024 Merge when tests, lint, PR quality gate, and mergeability are clean
- [ ] T025 Refresh `HANDOFF.md` after merge and validate it
