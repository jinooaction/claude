#!/usr/bin/env python3
"""Probe for the validation failure command replay contract."""
...
from auto_invest.analytics.validation_failure_command_replay import (
    ...
    write_validation_failure_command_replay_artifacts,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build validation failure command replay contract"
    )
