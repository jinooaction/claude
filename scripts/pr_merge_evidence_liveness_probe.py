...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="PR/merge evidence liveness probe")
    parser.add_argument(
        "--repo-root",
        type=Path,
        default=Path("."),
    ...
    parser.add_argument("--pr-body", type=Path, help="Pull request body Markdown file.")
    parser.add_argument("--released-work", type=Path, help="released_work.json file.")
    parser.add_argument("--deploy-status", type=Path, help="deploy-status observation text.")
    parser.add_argument(
        "--evidence-dir",
        type=Path,
        help="Directory containing pr-body.md, released-work.json, deploy-status.md.",
    )
    parser.add_argument(
        "--format",
...
def main(argv: list[str] | None = None) -> int:
    ...
    evidence = collect_repo_evidence(
        ...
        deploy_status_path=args.deploy_status,
