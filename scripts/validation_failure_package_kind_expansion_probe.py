#!/usr/bin/env python3
"""Probe for the validation failure package-kind expansion contract."""
...
from auto_invest.analytics.validation_failure_package_kind_expansion import (
    ...
    write_validation_failure_package_kind_expansion_artifacts,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build validation failure package-kind expansion contract"
    )
