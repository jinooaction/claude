#!/usr/bin/env python3
"""Run the no-order spec-152 Treasury carry factory."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        snapshots, quality = load_treasury_curve_bundle(
        ...
        print(f"Treasury carry factory input error: {exc}", file=sys.stderr)
        return 2

    summary = render_treasury_factory_markdown(payload)
