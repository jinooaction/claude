...
현재 계획 포인터: `specs/105-broker-diagnostic-liveness-contract/plan.md` — kis-smoke, execution-quality, pipeline-liveness 증거를 읽어 브로커 진단 생존성이 살아 있는지와 관측 대기·장애 상태를 분리하고, 완료 뒤 다음 거시 후보로 전진시키는 읽기 전용 계약 설계.
