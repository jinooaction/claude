...
현재 계획 포인터: `specs/072-candidate-evidence-diagnostics/plan.md` — 후보 결과 실행기의 `pending`/`blocked` 결과를 기계 판독 가능한 진단과 다음 안전 행동으로 분해하고 후보 공장 `promotion_evidence`까지 전달하는 증거 강화 설계.
