...
<!-- SPECKIT START -->
**Active feature**: `specs/157-commodity-positioning-gate-controls/plan.md`
...
현재 활성 포인터: `specs/157-commodity-positioning-gate-controls/plan.md` — 현실 양성 대조군으로 관문이 실제 엣지를 통과시키는지 감사하고 CFTC·EIA 원자재 재고·포지셔닝 후보 16개를 즉시 생산 검증한다. 자본·주문·허용목록·헌법·커널은 바꾸지 않는다.
