...
현재 계획 포인터: `specs/080-operator-dashboard-alert-loop/plan.md` — 운영자가 모바일에서 자율 루프 진행 상황, 실제 돈 경로 상태, 다음 자율 작업, 개입 필요 이벤트를 한눈에 확인하고 필요한 경우 Telegram 알림을 받게 하는 읽기 전용 운영 루프 설계.
