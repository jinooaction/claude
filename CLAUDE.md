...
현재 계획 포인터: `specs/102-execution-quality-frontier-map/plan.md` — execution-quality, KIS smoke, micro GTAA, money-path 증거를 읽어 체결 품질 frontier 지도를 만들고, 완료 뒤 첫 읽기 전용 브로커 거부 분류 후보로 전진시키는 설계.
