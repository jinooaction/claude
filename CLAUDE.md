...
현재 계획 포인터: `specs/110-agent-harness-regression-liveness-contract/plan.md` — evaluation, 첫 판단 품질, redteam 하네스 묶음과 strict 실행 증거를 함께 읽어 agent harness 회귀 방어의 PASS/WAIT/FAIL 상태를 구분하는 읽기 전용 운영 체계 계약.
