...
현재 계획 포인터: `specs/103-broker-rejection-taxonomy-contract/plan.md` — execution-quality, KIS smoke, micro GTAA 증거를 읽어 브로커 거부 코드·원인·재발 가능성을 분류하고, 완료 뒤 체결 비용 기준 후보로 전진시키는 읽기 전용 계약 설계.
