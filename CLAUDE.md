...
현재 계획 포인터: `specs/096-signal-diversification-edge-experiment/plan.md` — forward verdict, money-path, released-work, learning ledger, pipeline-liveness 증거를 함께 읽어 신호군 다양성·겹침·다음 no-live 후보를 기계 판독 보고서로 고정하는 설계.
