...
현재 계획 포인터: `specs/076-capital-path-readiness-loop/plan.md` — money-path, edge-autoarm, reassign, paper-forward, KIS smoke, promotion/evolution sidecar를 읽어 자본 투입 준비도와 다음 안전 행동을 자동 산출하는 읽기 전용 루프 설계.
