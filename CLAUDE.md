...
현재 계획 포인터: `specs/095-forward-regime-edge-experiment/plan.md` — forward 토너먼트, money-path, released-work, learning ledger, pipeline-liveness 증거를 함께 읽어 레짐별 forward edge no-live 실험 계약과 검증 기준을 기계 판독 보고서로 고정하는 설계.
