# 돈 경로 게이트 정렬 루프 (as of 2026-09-12T12:53:48Z)
...
|--------|--------|------|------|------|-----------|
| WAITING | forward_observation | EDGE_CONFIRMED | 14/20 | 전진 관측이 아직 최소 기준에 못 미치며 기존 게이트들이 같은 대기 상태다. | 전진 관측을 계속 누적하고, 최소 관측 이후 기존 자본 사다리로만 승격한다. |

## 입력 증거

| 증거 | 존재 | 파싱 | 상태 | 시각 | 요약 |
|------|:----:|------|------|------|------|
| money-path | yes | ok | REAL_ORDER_PATH_ARMED/DEPLOYED | 2026-09-12T11:57:29Z | live=REAL_ORDER_PATH_ARMED, stage=DEPLOYED, blocker=20% 승격은 별도 깨끗한 전진 40관측·PSR 0.80·칼마 우위·전체 경로 교정 필요. |
| capital-path-readiness | yes | ok | REAL_ORDER_PATH_ARMED/DEPLOYED | 2026-09-12T12:08:44Z | readiness=CAPITAL_ARMABLE, live=REAL_ORDER_PATH_ARMED, stage=DEPLOYED |
| edge-autoarm | yes | ok | STAY/INSUFFICIENT_DATA | 2026-09-12T01:37:12Z | action=STAY, forward=INSUFFICIENT_DATA, obs=14/20 |
| reassign | yes | ok | HOLD | 2026-09-12T04:42:24Z | action=HOLD, challenger=(없음), gates={'observation_quality_ok': True, 'challenger_confirmed': False, 'multiplicity_robust': False, 'canary_pass': False} |
| rebalance-paper-forward | yes | ok | OK | 2026-09-12T00:31:11Z | known=7, comparable=0, max_obs=14 |
| pipeline-liveness | yes | ok | DEGRADED | 2026-09-12T11:41:18Z | overall=DEGRADED, critical=(없음) |
| autonomous-work-execution | yes | ok | EXECUTION_READY | 2026-09-12T12:49:39Z | selected=candidate-parallel-edge-challenger-d59c4161bcba |
| kis-smoke | yes | ok | success | 2026-09-12T11:42:45Z | secrets_present=true, smoke_state=success, key_valid=true |
...
| trigger | schedule |
| timestamp_utc | 2026-09-12T12:53:48Z |
  ...
  "gate_surfaces": [
    {
      ...
      "timestamp_utc": "2026-09-12T11:57:29Z"
    },
    {
      ...
      "timestamp_utc": "2026-09-12T12:08:44Z"
    },
    {
      "key": "edge-autoarm",
      "parse_status": "ok",
      ...
      "summary_ko": "action=STAY, forward=INSUFFICIENT_DATA, obs=14/20",
    ...
    },
    {
      ...
      "timestamp_utc": "2026-09-12T04:42:24Z"
    },
    {
      ...
      "status": "OK",
      "summary_ko": "known=7, comparable=0, max_obs=14",
    ...
    },
    {
      ...
      "timestamp_utc": "2026-09-12T11:41:18Z"
    },
    {
      ...
      "timestamp_utc": "2026-09-12T12:49:39Z"
    },
    {
      "key": "kis-smoke",
      "parse_status": "ok",
      ...
      "timestamp_utc": "2026-09-12T11:42:45Z"
    }
  ],
  "live_money_status": "REAL_ORDER_PATH_ARMED",
  "next_action_ko": "전진 관측을 계속 누적하고, 최소 관측 이후 기존 자본 사다리로만 승격한다.",
