# 돈 경로 게이트 정렬 루프 (as of 2026-09-15T14:21:34Z)
...
| 증거 | 존재 | 파싱 | 상태 | 시각 | 요약 |
|------|:----:|------|------|------|------|
| money-path | yes | ok | REAL_ORDER_PATH_ARMED/NO_EDGE_YET | 2026-09-15T13:07:12Z | live=REAL_ORDER_PATH_ARMED, stage=NO_EDGE_YET, blocker=앵커드 OOS 실패: OOS walk-forward 엣지 미확정 — 강건한 엣지 없음: 구간 과반 실패(0/3); 평균 샤프가 단순 보유 이하. 라이브 배포 정당화 안 됨. |
| capital-path-readiness | yes | ok | REAL_ORDER_PATH_ARMED/NO_EDGE_YET | 2026-09-15T13:29:59Z | readiness=CAPITAL_ARMABLE, live=REAL_ORDER_PATH_ARMED, stage=NO_EDGE_YET |
| edge-autoarm | yes | malformed | malformed | 2026-09-15T01:56:43Z | 원문 존재, 구조화 JSON 파싱 실패 |
| reassign | yes | ok | HOLD | 2026-09-15T05:01:06Z | action=HOLD, challenger=(없음), gates={'observation_quality_ok': True, 'challenger_confirmed': False, 'multiplicity_robust': False, 'canary_pass': False} |
| rebalance-paper-forward | yes | ok | OK | 2026-09-15T00:51:21Z | known=7, comparable=0, max_obs=15 |
| pipeline-liveness | yes | ok | DEGRADED | 2026-09-15T12:47:46Z | overall=DEGRADED, critical=(없음) |
| autonomous-work-execution | yes | ok | EXECUTION_READY | 2026-09-15T14:18:20Z | selected=candidate-parallel-edge-challenger-d59c4161bcba |
| kis-smoke | yes | ok | success | 2026-09-15T08:28:54Z | secrets_present=true, smoke_state=success, key_valid=true |
...
| trigger | schedule |
| timestamp_utc | 2026-09-15T14:21:34Z |
  ...
  "gate_surfaces": [
    {
      ...
      "timestamp_utc": "2026-09-15T13:07:12Z"
    },
    {
      ...
      "timestamp_utc": "2026-09-15T13:29:59Z"
    },
    {
      "key": "edge-autoarm",
    ...
    },
    {
      ...
      "timestamp_utc": "2026-09-15T05:01:06Z"
    },
    {
      ...
      "status": "OK",
      "summary_ko": "known=7, comparable=0, max_obs=15",
    ...
    },
    {
      ...
      "timestamp_utc": "2026-09-15T12:47:46Z"
    },
    {
