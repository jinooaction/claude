...
```json
{
  "as_of_utc": "2026-09-18T18:08:41Z",
  "counts": {
    "records": 1,
    "rejected_orders": 2,
    "valued_orders": 2,
...
```json
{
  ...
  "as_of_utc": "2026-09-19T00:33:28.124213+00:00",
  "challenger_key": null,
  "champion_key": null,
  "champion_multiplicity_robust": null,
  "comparable_count": 0,
  "headline": "⏳ 아직 비교 불가 — 비교 가능 트랙 0개(모두 관측 부족, 누적 중). 최다 관측: 추세 필터 ON (드로다운 방어)(19/20).",
