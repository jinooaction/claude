...
```json
{"portfolio_id": "global-trend-fixed", "mode": "dry-run", "account_wide": true, "requested_side": "both", "effective_side": "both", "purchasable_cash_usd": "830.89", "required_cash_usd": "0.00", "planned_buy_notional_usd": "0.00", "planned_sell_notional_usd": "0.00", "target_weights": {"SCHX": "0.333334"}, "signal_target_weights": {"SPY": "0.333334"}, "execution_symbol_map": {"SPY": "SCHX", "IEF": "SPTI", "GLD": "IAUM"}, "fundability": {"schema_version": "1.1", "fundable": true, "capital_usd": "137.0", "investable_usd": "135.630", "active_target_count": 1, "funded_target_count": 1, "funded_target_ratio": "1", "whole_share_eligible_target_count": 1, "funded_whole_share_target_count": 1, "funded_whole_share_target_ratio": "1", "whole_share_ineligible_targets": {}, "quote_coverage_ratio": "1", "invested_fraction": "0.99", "target_weights": {"SCHX": "0.333334"}, "holdings": {"SCHX": 2}, "prices": {"SCHX": "30.3700"}, "order_prices": {}, "planned_orders": [], "caps": {"per_trade_pct": "50.0", "per_symbol_pct": "60.0", "global_exposure_pct": "100.0", "canary_capital_pct": "10.0", "canary_min_duration_days": 10, "canary_acceptance_drawdown_pct": "3.0", "circuit_breaker_enabled": true, "daily_loss_limit_pct": "10", "max_total_drawdown_pct": "20"}, "effective_side": "both", "projected_quantities": {"SCHX": 2}, "projected_weights": {"SCHX": "0.4433576642335766423357664234"}, "l1_weight_error": "0.1133570042335766423357664234", "max_leg_weight_error": "0.1133570042335766423357664234", "checks": {"capital_positive": true, "invested_fraction_bounded": true, "holdings_long_only": true, "active_targets_present": true, "target_weights_bounded": true, "quote_coverage": true, "exposure_quote_coverage": true, "whole_share_eligible_targets_present": true, "funded_whole_share_target_ratio": true, "l1_weight_error": true, "max_leg_weight_error": true, "exposure_caps": true}, "reasons": []}, "results": [], "withheld_orders": [{"symbol": "IAUM", "side": "SELL", "requested_qty": 1, "reason": "unmanaged_holding"}, {"symbol": "ORANY", "side": "SELL", "requested_qty": 28, "reason": "unmanaged_holding"}]}
```

## 실행 대체 ETF 동등성 감사 (KIS read-only, 주문 0건)
```json
{"checks": {"all_pairs_passed": true, "mapping_exact": true, "pair_count": true}, "contract": {"lookback_sessions": 252, "max_annualized_return_gap": 0.03, "max_annualized_tracking_error": 0.06, "max_evidence_age_hours": 36.0, "max_market_data_age_days": 7, "min_common_sessions": 252, "min_median_dollar_volume_usd": "1000000", "min_return_correlation": 0.95}, "dataset_version": "sqlite-price_bars-1d", "evidence_digest": "sha256:17e1ef6aa40952a6155fe74962916d347c50f478a60d0a05612906c31847247f", "observed_at_utc": "2026-09-26T02:04:09.638662Z", "pairs": [{"annualized_return_gap": 0.003985963315750851, "annualized_tracking_error": 0.008265166350900653, "checks": {"annualized_return_gap": true, "annualized_tracking_error": true, "common_sessions": true, "execution_liquidity": true, "freshness": true, "latest_session_aligned": true, "return_correlation": true}, "common_sessions": 252, "execution_latest_session": "2026-09-25", "execution_symbol": "IAUM", "first_session": "2025-09-25", "last_session": "2026-09-25", "median_execution_dollar_volume_usd": "120493880.0600", "passed": true, "return_correlation": 0.9996548375597216, "signal_latest_session": "2026-09-25", "signal_symbol": "GLD"}, {"annualized_return_gap": 0.015000796598315547, "annualized_tracking_error": 0.01599457299755777, "checks": {"annualized_return_gap": true, "annualized_tracking_error": true, "common_sessions": true, "execution_liquidity": true, "freshness": true, "latest_session_aligned": true, "return_correlation": true}, "common_sessions": 252, "execution_latest_session": "2026-09-25", "execution_symbol": "SPTI", "first_session": "2025-09-25", "last_session": "2026-09-25", "median_execution_dollar_volume_usd": "52839823.5204", "passed": true, "return_correlation": 0.9803964438818321, "signal_latest_session": "2026-09-25", "signal_symbol": "IEF"}, {"annualized_return_gap": 0.005475982752007669, "annualized_tracking_error": 0.009965750613084306, "checks": {"annualized_return_gap": true, "annualized_tracking_error": true, "common_sessions": true, "execution_liquidity": true, "freshness": true, "latest_session_aligned": true, "return_correlation": true}, "common_sessions": 252, "execution_latest_session": "2026-09-25", "execution_symbol": "SCHX", "first_session": "2025-09-25", "last_session": "2026-09-25", "median_execution_dollar_volume_usd": "399501251.8842", "passed": true, "return_correlation": 0.9970775840974921, "signal_latest_session": "2026-09-25", "signal_symbol": "SPY"}], "passed": true, "schema_version": "1.0", "symbol_map": {"GLD": "IAUM", "IEF": "SPTI", "SPY": "SCHX"}}
```

## 탐색 진입 hardened canary JSON (격리, 주문 0건)
```json
{"schema_version": "1.1", "outcome": "passed", "verdict": "PASS", "tier": "L3", "failing_metrics": [], "candidate_drawdown_pct": 3.122999, "shock_violations": 0, "audit_integrity_count": 0, "audit_integrity_holes": [], "fuzz_counterexamples": 0, "window_gate_rejections": 0, "resolved_shock_dates": ["2024-08-05", "2026-09-18"], "skipped_shock_dates": ["2020-03-12", "2020-04-20"], "portfolio_id": "global-trend-fixed", "window_start": "2026-07-24", "window_end": "2026-09-25", "window_common_session_count": 45}
```

## 라이브 실적 JSON (현재 단 진입 이후, read-only)
```json
{"schema_version": "1.0", "mode": "live", "snapshot_count": 23, "first_at_utc": "2026-09-05T01:46:21.256Z", "last_at_utc": "2026-09-25T18:40:31.079Z", "starting_nav_usd": "143.0", "current_nav_usd": "141.94740000", "absolute_change_usd": "-1.05260000", "total_return_pct": "-0.736084", "max_drawdown_pct": "1.282797", "period_days": "20.704280358796296", "cagr_pct": "-12.212028"}
```
...
```json
{
  ...
  "period": {
    ...
    "until_utc": "2026-09-26T02:04:23.676Z"
  },
  "fills_count": 2,
  "gross_invested_usd": "104.45260000",
  "realized_pnl_usd": "0",
  "unrealized_pnl_usd": "-0.94260000",
  "total_pnl_usd": "-0.94260000",
  "return_pct": "-0.9024188962266137941994742113",
  "per_symbol": [
    {
      "symbol": "IAUM",
      "qty": 1,
      ...
      "realized_pnl_usd": "0",
      "unrealized_pnl_usd": "-1.22500000",
      "mark_price_usd": "42.7700",
      "market_value_usd": "42.7700",
      "total_pnl_usd": "-1.22500000"
    },
    {
      "symbol": "SCHX",
      "qty": 2,
      ...
      "realized_pnl_usd": "0",
      "unrealized_pnl_usd": "0.28240000",
      "mark_price_usd": "30.3700",
      "market_value_usd": "60.7400",
      "total_pnl_usd": "0.28240000"
    }
  ],
  "per_rule": [
    {
  ...
  "excluded_unrealized_pnl_usd": "131.46000000",
  "slippage": {
    "measurable_fills": 2,
