# 완료 후보 소비 장부 (as of 2026-09-21T02:41:05.311757Z)
...
| candidate-broad-no-edge-cross-asset-relative-value-experiment | released | 135-broad-no-edge-cross-asset-relative-value | specs/135-broad-no-edge-cross-asset-relative-value/spec.md | completed_candidate_id |
| candidate-broad-no-edge-data-gap-audit | released | 133-broad-no-edge-data-gap-audit | specs/133-broad-no-edge-data-gap-audit/spec.md | completed_candidate_id |
...
| candidate-single-execution-authority | released | 116-single-execution-authority | specs/116-single-execution-authority/spec.md | completed_candidate_id |
...
| candidate-submission-unknown-broker-lookup | released | 117-submission-unknown-broker-lookup | specs/117-submission-unknown-broker-lookup/spec.md | completed_candidate_id |
...
| 193-observed-intraday-inputs | 체크박스 작업이 없거나 완료되지 않았습니다. |
...
```json
{
  "commit": "83c6d2061b45a5b3a978d7b06ccb3b5fe96b983c",
  "overall_status": "OK",
  "released_work": [
    {
    ...
    {
      "candidate_id": "candidate-agent-ops-frontier-map",
      "entry_id": "released-909315767dae",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/106-agent-ops-frontier-map/spec.md",
      "spec_id": "106-agent-ops-frontier-map",
      "status": "released"
    },
    {
      "candidate_id": "candidate-atomic-fill-ledger",
      "entry_id": "released-4e1c1cdad469",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/113-atomic-fill-ledger/spec.md",
      "spec_id": "113-atomic-fill-ledger",
      "status": "released"
    },
    {
      "candidate_id": "candidate-autonomous-frontier-discovery",
      "entry_id": "released-7461df6a3b05",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/092-frontier-candidate-discovery/contracts/frontier-candidate-discovery.md",
      "spec_id": "092-frontier-candidate-discovery",
      "status": "released"
    },
    {
      "candidate_id": "candidate-autonomous-growth-objective-calibration",
      "entry_id": "released-5c52a6325649",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
    ...
    {
      "candidate_id": "candidate-broad-frontier-expansion-validation-failures-22f38b8629eb",
      "entry_id": "released-2654dfde7b8b",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/126-broad-validation-failure-frontier/spec.md",
      "spec_id": "126-broad-validation-failure-frontier",
      "status": "released"
    },
    {
      "candidate_id": "candidate-broad-no-edge-asset-universe-rotation-experiment",
      "entry_id": "released-0cf545503cf4",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/125-broad-no-edge-asset-universe/spec.md",
      "spec_id": "125-broad-no-edge-asset-universe",
      "status": "released"
    },
    {
      "candidate_id": "candidate-broad-no-edge-cross-asset-relative-value-experiment",
      "entry_id": "released-b3db4811cf45",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/135-broad-no-edge-cross-asset-relative-value/spec.md",
      "spec_id": "135-broad-no-edge-cross-asset-relative-value",
      "status": "released"
    },
    {
      "candidate_id": "candidate-broad-no-edge-data-gap-audit",
      "entry_id": "released-dd1f1d5e6510",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/133-broad-no-edge-data-gap-audit/spec.md",
      "spec_id": "133-broad-no-edge-data-gap-audit",
      "status": "released"
    },
    {
      "candidate_id": "candidate-broad-no-edge-multi-horizon-signal-experiment",
      "entry_id": "released-ad7ecf687767",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
    ...
    {
      "candidate_id": "candidate-broad-no-edge-tail-risk-convexity-experiment",
      "entry_id": "released-153b88207523",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
    ...
    {
      "candidate_id": "candidate-broad-validation-failure-command-replay-contract",
      "entry_id": "released-92fc11ada159",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
    ...
    {
      "candidate_id": "candidate-broad-validation-failure-package-kind-expansion-contract",
      "entry_id": "released-ee43d7c5d40d",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
    ...
    },
    {
      ...
      "entry_id": "released-5ec4ff984173",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/105-broker-diagnostic-liveness-contract/spec.md",
      "spec_id": "105-broker-diagnostic-liveness-contract",
      "status": "released"
    },
    {
    ...
    },
    {
      ...
      "entry_id": "released-99bf561ce3b0",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
    ...
    },
    {
      ...
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/083-rejected-order-execution-quality/contracts/execution-quality.md",
      "spec_id": "083-rejected-order-execution-quality",
      "status": "released"
    },
    {
    ...
    {
      "candidate_id": "candidate-evolution-source-diversification",
      "entry_id": "released-3a5107ade49f",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
    ...
    },
    {
      ...
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/122-forward-paper-db-writability/spec.md",
      "spec_id": "122-forward-paper-db-writability",
      "status": "released"
    },
    {
      "candidate_id": "candidate-forward-regime-edge-experiment",
      "entry_id": "released-fc586071d07a",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/095-forward-regime-edge-experiment/spec.md",
    ...
    },
    {
      ...
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/094-investment-edge-frontier-map/spec.md",
      "spec_id": "094-investment-edge-frontier-map",
      "status": "released"
    },
    {
    ...
    },
    {
      ...
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/093-macro-candidate-map-regenerator/data-model.md",
      "spec_id": "093-macro-candidate-map-regenerator",
      "status": "released"
    },
    {
    ...
    },
    {
      ...
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/112-order-submission-uncertainty-recovery/spec.md",
      "spec_id": "112-order-submission-uncertainty-recovery",
      "status": "released"
    },
    {
    ...
    },
    {
      ...
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/121-promote-readiness-observe-gateway/spec.md",
      "spec_id": "121-promote-readiness-observe-gateway",
      "status": "released"
    },
    {
    ...
    },
    {
      ...
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/096-signal-diversification-edge-experiment/spec.md",
      "spec_id": "096-signal-diversification-edge-experiment",
      "status": "released"
    },
    {
      "candidate_id": "candidate-single-execution-authority",
      "entry_id": "released-0d3975e39a40",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/116-single-execution-authority/spec.md",
      "spec_id": "116-single-execution-authority",
      "status": "released"
    },
    {
    ...
    {
      "candidate_id": "candidate-submission-unknown-broker-lookup",
      "entry_id": "released-0f1155c78a14",
      "reason_ko": "완료된 Speckit 작업 산출물에서 명시적으로 완료 후보로 기록되었습니다.",
      "source_field": "completed_candidate_id",
      "source_file": "specs/117-submission-unknown-broker-lookup/spec.md",
      "spec_id": "117-submission-unknown-broker-lookup",
      "status": "released"
    },
    {
  ...
  "scanned_specs": [
    ...
    "091-autonomous-growth-objective-calibration",
    "092-frontier-candidate-discovery",
    ...
    "146-daily-cross-asset-ml",
    "147-account-ledger-low-turnover",
    "148-reconciliation-halt-recovery",
    "149-live-entry-revalidation",
    "150-autonomous-strategy-factory",
    ...
    "184-intraday-operator-program",
    "185-intraday-archive-review",
    "186-account-source-collection",
    "188-kis-history-depth",
    "189-kis-five-symbol-review",
    "190-cost-aware-intraday",
    "191-shock-recovery-research",
  ...
  "skipped_specs": [
    ...
    {
      "reason_ko": "체크박스 작업이 없거나 완료되지 않았습니다.",
      "spec_id": "140-heldout-exploration-canary"
    },
    {
      "reason_ko": "체크박스 작업이 없거나 완료되지 않았습니다.",
    ...
    {
      "reason_ko": "체크박스 작업이 없거나 완료되지 않았습니다.",
      "spec_id": "182-intraday-kis-execution"
    },
    {
      "reason_ko": "체크박스 작업이 없거나 완료되지 않았습니다.",
    ...
    {
      "reason_ko": "체크박스 작업이 없거나 완료되지 않았습니다.",
      "spec_id": "193-observed-intraday-inputs"
    }
  ],
  "timestamp_utc": "2026-09-21T02:41:05.311757Z"
}
```
