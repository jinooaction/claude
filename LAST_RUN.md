...
| timestamp_utc | 2026-09-15T18:15:53Z |
| armed (무장 여부) | true |
...
## 첫 체결 전 최신 엣지 재검증
```json
evidence_age_hours=3.911388888888889 canary_exit=0 profit_exit=0 proxy_parity_exit=0 fundability_exit=0
...
(스냅샷 기록됨: LIVE_PERFORMANCE_SNAPSHOT seq=19027)
...
```
--- nav + forward verdict ---
(스냅샷 기록됨: PORTFOLIO_NAV_SNAPSHOT seq=19028)
{"schema_version": "1.0", "source": "ledger", "cash_usd": "38.54740000", "total_market_value_usd": "102.6182", "total_nav_usd": "141.16560000", "total_unrealized_pnl_usd": "-1.83440000", "broker_reported_nav_usd": null, "holdings": [{"symbol": "IAUM", "qty": 1, "avg_cost_usd": "43.99500000", "mark_price_usd": "42.8700", "market_value_usd": "42.8700", "marked": true, "weight_pct": "30.36858838130536051275948248", "unrealized_pnl_usd": "-1.12500000"}, {"symbol": "SCHX", "qty": 2, "avg_cost_usd": "30.22880000", "mark_price_usd": "29.8741", "market_value_usd": "59.7482", "marked": true, "weight_pct": "42.32490068401933615555064407", "unrealized_pnl_usd": "-0.70940000"}], "unmarked_symbols": [], "drifts": [], "total_qty_drift": 0, "total_value_drift_usd": "0", "data_quality_warnings": [], "mode": "live", "measurement_contract_id": "sha256:2542c0ddd4499481582d820ebee48fadbbfbab9b6208c749d843c025b74288d8", "measurement_scope": "strategy", "excluded_fills_count": 3, "capital_basis_usd": "143.0", "ledger_cash_nonnegative": true, "measurement_valid": true}
{"schema_version": "1.2", "verdict": "NO_EDGE", "reason": "\ub2e8\uc21c \ubcf4\uc720\ub97c \uc704\ud5d8\uc870\uc815\uc73c\ub85c \ubabb \uc774\uae40; \ub2a5\ub3d9 \uc218\uc775\ub960 PSR 0.668906 < 0.95(\uc6b0\uc5f0\uacfc \uad6c\ubcc4 \uc548 \ub428)", "n_obs": 44, "min_obs_required": 20, "strategy_sharpe_annual": "-3.159049", "strategy_total_return_pct": "-1.282797", "strategy_max_drawdown_pct": "1.282797", "strategy_calmar": "-5.556362", "benchmark_sharpe_annual": "-2.214172", "benchmark_total_return_pct": "-2.290259", "benchmark_max_drawdown_pct": "2.499214", "benchmark_calmar": "-4.972269", "excess_return_pct": "1.007462", "beats_benchmark_calmar": false, "significance_method": "paired_active_return_psr_v1", "active_information_ratio_annual": "1.109060", "psr_vs_benchmark": "0.668906", "dsr": null, "num_trials": 1, "min_track_record_obs": "610.491915", "dsr_threshold": "0.95", "has_benchmark": true, "mode": "live", "snapshot_count": 45, "legacy_snapshots_excluded": 91, "universe": ["SPY", "IEF", "GLD"]}
...
--- live performance ---
{
  ...
  "period": {
    ...
    "until_utc": "2026-09-15T18:15:46.222Z"
  },
  "fills_count": 2,
  "gross_invested_usd": "104.45260000",
  "realized_pnl_usd": "0",
  "unrealized_pnl_usd": "-1.82440000",
  "total_pnl_usd": "-1.82440000",
  "return_pct": "-1.746629571690891370822746394",
  "per_symbol": [
    {
      "symbol": "IAUM",
      "qty": 1,
      ...
      "realized_pnl_usd": "0",
      "unrealized_pnl_usd": "-1.11500000",
      "mark_price_usd": "42.8800",
      "market_value_usd": "42.8800",
      "total_pnl_usd": "-1.11500000"
    },
    {
      "symbol": "SCHX",
      "qty": 2,
      ...
      "realized_pnl_usd": "0",
      "unrealized_pnl_usd": "-0.70940000",
      "mark_price_usd": "29.8741",
      "market_value_usd": "59.7482",
      "total_pnl_usd": "-0.70940000"
    }
  ],
  "per_rule": [
    {
  ...
  "excluded_unrealized_pnl_usd": "196.42000000",
  "slippage": {
    "measurable_fills": 2,
...
--- performance stderr ---
(스냅샷 기록됨: LIVE_PERFORMANCE_SNAPSHOT seq=19029)
```
...
```json
{
  "schema_version": "1.0",
  "status": "CLEAR",
  "observed_at_utc": "2026-09-15T18:15:52.864Z",
